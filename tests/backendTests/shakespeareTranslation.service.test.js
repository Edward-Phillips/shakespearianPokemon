...
const mockShakespeareTranslationAPIRequests = (translatedText) =>
...
describe("shakespeareTranslation", () => {
  it(`should return the translated text of charizard's description`, async () => {
    mockShakespeareTranslationAPIRequests(
      "Spits fire yond is hot enow to melt boulders. Known to cause forest fires unintentionally."
    );
    const translatedText = await shakespeareTranslationService(
